...
export default function BasicTable() {
    ...
    return (
        <>
            <div className='home' style={{ height: "110px", width: "1320px", backgroundColor: "#FAF9F6" }}>
...
<button onClick={suw}>User</button>
                ...
                <div>
                    <img style={{ paddingTop:"3.5%",paddingLeft:"11.4%",width: "100%", height: "790px", borderRadius: "10px" }} src="images/stu.png" />
                </div>
            </div>
