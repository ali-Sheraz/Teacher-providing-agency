...
const Admlogin = () => {
  ...
  return (
    ...
    <div>
      ...
      <div className='main' style={{ 'marginTop': "30px", 'display': "flex", 'marginLeft': "50px", 'marginRight': "50px", 'height': "auto", 'backgroundColor': "whitesmoke", 'borderRadius': "20px" }}>
        <h5 style={{ width: "350px", height: "150px", marginLeft: "20px", fontWeight:"800",fontSize:"xx-large",marginTop:"15px"}}>ADMIN</h5> 
