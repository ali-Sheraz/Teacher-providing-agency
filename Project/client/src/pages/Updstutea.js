...
export default function BasicTable() {
    ...
    useEffect(() => {
        axios.get("http://localhost:1337/api/Getuserers").then(async (result) => {
            // console.log("result => ", result?.data?.User)
            setCourseTeacher(result?.data?.User);
        }).catch((error) => {
            alert("error")
        })
    }, [])
...
<button onClick={suw}>User</button>
            ...
            <TableContainer component={Paper} sx={{ marginLeft: 2, width: "75%", marginLeft: "16%", marginTop: "-55%" }}>
                <Table sx={{ minWidth: 65 }} aria-label="simple table">
                    <TableHead>
                        <TableRow sx={{ backgroundColor: "#007FFF", }}>
                            ...
                            <TableCell sx={{ color: "white", marginLeft: "2px" }} align="center">ViewSeminar</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                            ...
                            return (
                                <>
                                    ...
                                    >
                                        ...
                                        <TableCell align="right"><div className="hom"><button onClick={()=>handleOpen(row.Seminars)} >ViewSeminar</button></div></TableCell>
            ...
            >
                <Box sx={e}>
                {
                        selectedArray.map((user)=>(
                           ...
                           <li style={{fontWeight:"bold"}}>{user.title}</li>
                           <li >{user.time}</li>
                        </Typography>
                        ))
