            ...
            <div style={{ display: "flex" }}>
                ...
                <div style={{ marginTop: "105px" }}>
                    ...
                    <div className='sidebar1' style={{ marginLeft: "-30px", marginTop: "5px" }}>
                        <p onClick={search}>Requests Course</p>
                    </div> */}
                    <div className="sidepic1" style={{ marginLeft: "-25px" }}>
                    ...
                    <div className="profile-view">
                        ...
                        <div className="profile-body">
                            ...
                            <div className="profile-info">
                                ...
                                <p className="profile-detail"><span style={{ fontWeight: "bold" }}>course:</span>{courseget}</p>
                            ...
                            <div className="profile-info">
                                ...
                                <p className="profile-detail"><span style={{ fontWeight: "bold" }}>Experience:</span>{experienceget}</p>
