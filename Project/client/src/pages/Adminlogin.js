...
<button onClick={suw}>User</button>
                ...
                <div>
                    <img style={{ paddingTop:"2.7%",paddingLeft:"11.4%",width: "100%", height: "930px", borderRadius: "10px" }} src="images/ad.jpg" />
                </div>
            </div>
            <div style={{ display: "flex", direction: "row", overflow: "hidden" }}>
                ...
                <div className="sidepic1" style={{ marginLeft: "-25px" }}>
                    ...
                    <div className="sidepic1" style={{ marginLeft: "-25px", marginTop: "5px" }}>
                        < YoutubeSearchedForIcon onClick={updat} sx={style.tr} size={70} />
                    </div>
                    <div className='sidebar1' style={{ marginLeft: "-25px", marginTop: "5px" }}>
                        <p onClick={updat}>Management</p>
                    </div>
                    {/* <div className="sidepic1" style={{ marginLeft: "-25px", marginTop: "5px" }}>
                        <YoutubeSearchedForIcon SystemUpdateIcon onClick={search} sx={sty.tr} size={70} />
                    </div>
